...
MenuState menu_state = SELECT_ALGORITHM;
...
int main()
{
    ...
    // Load font
    ALLEGRO_FONT *font = al_load_ttf_font("/home/jsk/Progetto_Dragoni_finito/Font/Pixel.TTF", 24, 0);
    ALLEGRO_FONT *small_font = al_load_ttf_font("/home/jsk/Scaricati/minecraftia/Minecraft.ttf", 12, 0);
    if (!font || !small_font)
    {
